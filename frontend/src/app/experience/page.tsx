            ...
            <section className="container mx-auto py-20 px-6">
                ...
                <div className="mb-25" id='cloud'>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="bg-card overflow-hidden p-6 flex flex-col justify-between border-border border rounded-lg">
                            <h3 className="text-xl font-semibold text-subheading mb-2">AWS</h3>
                            <p>
                        ...
                        <div className="bg-card overflow-hidden p-6 flex flex-col justify-between border-border border rounded-lg">
                            <h3 className="text-xl font-semibold text-subheading mb-2">Microsoft Azure</h3>
                            <p>
                ...
                <div className="mb-25" id='devops'>
                    ...
                    <div className="bg-card overflow-hidden p-6 flex flex-col justify-between border-border border rounded-lg">
                    <h3 className="text-xl font-semibold text-subheading mb-2">Python</h3>
                            <p>
                        ...
                        <div className="bg-card overflow-hidden p-6 flex flex-col justify-between border-border border rounded-lg">
                            <h3 className="text-xl font-semibold text-subheading mb-2">CI/CD Pipelines</h3>
                            <p>
                        ...
                        <div className="bg-card overflow-hidden p-6 flex flex-col justify-between border-border border rounded-lg">
                            <h3 className="text-xl font-semibold text-subheading mb-2">Containerization</h3>
                            <p>
                        ...
                        <div className="bg-card overflow-hidden p-6 flex flex-col justify-between border-border border rounded-lg">
                            <h3 className="text-xl font-semibold text-subheading mb-2">Terraform</h3>
                            <p>
                        ...
                        <div className="bg-card overflow-hidden p-6 flex flex-col justify-between border-border border rounded-lg">
                            <h3 className="text-xl font-semibold text-subheading mb-2">Bash</h3>
                            <p>
                        ...
                        <div className="bg-card overflow-hidden p-6 flex flex-col justify-between border-border border rounded-lg">
                            <h3 className="text-xl font-semibold text-subheading mb-2">Linux</h3>
                            <p>
                ...
                <div id='development'>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="bg-card overflow-hidden p-6 flex flex-col justify-between border-border border rounded-lg">
                            <h3 className="text-xl font-semibold text-subheading mb-2">Git/GitHub</h3>
                            <p>
                        ...
                        <div className="bg-card overflow-hidden p-6 flex flex-col justify-between border-border border rounded-lg">
                            <h3 className="text-xl font-semibold text-subheading mb-2">Object Oriented Programming</h3>
                            <p>
                        ...
                        <div className="bg-card overflow-hidden p-6 flex flex-col justify-between border-border border rounded-lg">
                            <h3 className="text-xl font-semibold text-subheading mb-2">Full-Stack</h3>
                            <p>
                        ...
                        <div className="bg-card overflow-hidden p-6 flex flex-col justify-between border-border border rounded-lg">
                            <h3 className="text-xl font-semibold text-subheading mb-2">SQL</h3>
                            <p>
